...
- **Related KPI**: Sales velocity, revenue velocity, monthly revenue
- **Updates**: Recorded automatically at time of transaction (UTC)
...
### flag_churn
- **Type**: Integer
- **Business Meaning**: Whether customer left within 90 days (0/1 binary indicator)
- **Example**: 0
- **Null Handling**: Default to 0
- **Related KPI**: Churn rate prediction, churn by segment
- **Updates**: Updated quarterly post-transaction evaluation window
...
### Average Order Value
- **Formula**: AVG(trnx_amt)
- **Related Columns**: trnx_amt, customer_id
- **Why It Matters**: Measures average spending per transaction across customer base
- **Update Frequency**: Daily
